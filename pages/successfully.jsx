            ...
            <Layout lang={this.state.lang[this.props.locale]}>
                ...
                <div className={style.App_main}>
                    <div className={style.card}>
                        ...
                        <h1 className={style.card_h1}>{this.state.lang[this.props.locale].success.title}</h1>
                        <p className={style.card_p}>{this.state.lang[this.props.locale].success.message};<br /> {this.state.lang[this.props.locale].success.message1}</p>
                    </div>
                </div>
            </Layout>
        </>);
